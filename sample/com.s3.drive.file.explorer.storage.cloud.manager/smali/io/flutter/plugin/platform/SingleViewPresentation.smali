...
.field private rootView:Lio/flutter/plugin/platform/n;

.field private startFocused:Z

.field private final state:Lio/flutter/plugin/platform/q;

.field private viewId:I


# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/view/Display;Lio/flutter/plugin/platform/a;Lio/flutter/plugin/platform/q;Landroid/view/View$OnFocusChangeListener;Z)V
    .locals 2
    ...
    .line 17
    invoke-direct {v0, p1, v1}, Lio/flutter/plugin/platform/o;-><init>(Landroid/content/Context;Landroid/view/inputmethod/InputMethodManager;)V
    ...
    .line 21
    iput-object p4, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/q;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Display;Lio/flutter/plugin/platform/e;Lio/flutter/plugin/platform/a;ILandroid/view/View$OnFocusChangeListener;)V
    ...
    .line 9
    new-instance p1, Lio/flutter/plugin/platform/q;

    .line 10
    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    .line 11
    iput-object p1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/q;

    .line 12
    iput-object p3, p1, Lio/flutter/plugin/platform/q;->a:Lio/flutter/plugin/platform/e;
...
# virtual methods
.method public detachState()Lio/flutter/plugin/platform/q;
    .locals 1
    ...
    .line 8
    :cond_0
    iget-object v0, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->rootView:Lio/flutter/plugin/platform/n;
    ...
    .line 15
    :cond_1
    iget-object v0, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/q;
...
.method public getView()Lio/flutter/plugin/platform/e;
    ...
    .line 2
    .line 3
    iget-object v0, v0, Lio/flutter/plugin/platform/q;->a:Lio/flutter/plugin/platform/e;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 16
    .line 17
    iget-object p1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/q;

    .line 18
    .line 19
    iget-object v0, p1, Lio/flutter/plugin/platform/q;->c:Lio/flutter/plugin/platform/m;
    ...
    .line 29
    invoke-direct {v0, v1}, Lio/flutter/plugin/platform/m;-><init>(Landroid/content/Context;)V

    .line 30
    .line 31
    .line 32
    iput-object v0, p1, Lio/flutter/plugin/platform/q;->c:Lio/flutter/plugin/platform/m;
    ...
    .line 35
    .line 36
    iget-object p1, p1, Lio/flutter/plugin/platform/q;->b:Lio/flutter/plugin/platform/x;
    ...
    .line 55
    .line 56
    iget-object v2, v0, Lio/flutter/plugin/platform/q;->c:Lio/flutter/plugin/platform/m;

    .line 57
    .line 58
    invoke-direct {v1, p1, v2}, Lio/flutter/plugin/platform/x;-><init>(Landroid/view/WindowManager;Lio/flutter/plugin/platform/m;)V

    .line 59
    .line 60
    .line 61
    iput-object v1, v0, Lio/flutter/plugin/platform/q;->b:Lio/flutter/plugin/platform/x;
    ...
    .line 80
    iget-object v1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->state:Lio/flutter/plugin/platform/q;

    .line 81
    .line 82
    iget-object v1, v1, Lio/flutter/plugin/platform/q;->b:Lio/flutter/plugin/platform/x;
    ...
    .line 85
    .line 86
    invoke-direct {p1, v0, v1, v2}, Lio/flutter/plugin/platform/p;-><init>(Landroid/content/Context;Lio/flutter/plugin/platform/x;Landroid/content/Context;)V
    ...
    .line 153
    .line 154
    invoke-direct {p1, v1, v2, v0}, Lio/flutter/plugin/platform/n;-><init>(Landroid/content/Context;Lio/flutter/plugin/platform/a;Landroid/view/View;)V

    .line 155
    .line 156
    .line 157
    iput-object p1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->rootView:Lio/flutter/plugin/platform/n;
    ...
    .line 163
    .line 164
    iget-object p1, p0, Lio/flutter/plugin/platform/SingleViewPresentation;->rootView:Lio/flutter/plugin/platform/n;
    ...
    .line 167
    .line 168
    iget-object v1, v1, Lio/flutter/plugin/platform/q;->c:Lio/flutter/plugin/platform/m;
